...
},{"axios":"../node_modules/axios/index.js"}],"product-api.js":[function(require,module,exports) {
"use strict";
...
var searchByName = /*#__PURE__*/function () {
  ...
  return function searchByName(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var _productApi = require("./product-api");
