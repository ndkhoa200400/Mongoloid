...
var changepassBtn = document.querySelector('.form--changepass');
...
if (changepassBtn) {
  changepassBtn.addEventListener('submit', function (e) {
    console.log('po');
    e.preventDefault();
    var passwordCurrent = document.querySelector('.oldpass-check').value;
    var password = document.querySelector('.newpass').value;
    (0, _login.changePassword)(passwordCurrent, password);
  });
}
